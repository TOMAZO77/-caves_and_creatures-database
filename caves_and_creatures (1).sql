...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2024 at 11:57 AM
...
CREATE TABLE `item_rarity` (
  ...
  `item_rarity_description` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'Common', 'Cheap common item which has 15% chance to drop and is found in abundance.');
...
--
ALTER TABLE `item_rarity`
  MODIFY `item_rarity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
