...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2024 at 01:10 PM
...
(1, 'Tomahawk', 'A common one-handed axe.', 3, 2);
...
(1, 'one-handed axe', 'A single hand wielded axe.');
...
ALTER TABLE `character`
  ...
  ADD CONSTRAINT `character_ibfk_2` FOREIGN KEY (`class_id`) REFERENCES `class` (`class_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `character_ibfk_3` FOREIGN KEY (`character_type_id`) REFERENCES `character_type` (`character_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `character_ibfk_4` FOREIGN KEY (`species_id`) REFERENCES `species` (`species_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `character_ibfk_5` FOREIGN KEY (`alignment_id`) REFERENCES `alignment` (`alignment_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `character_ibfk_6` FOREIGN KEY (`inventory_id`) REFERENCES `inventory` (`inventory_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `character_quest`
--
ALTER TABLE `character_quest`
  ADD CONSTRAINT `character_quest_ibfk_1` FOREIGN KEY (`character_id`) REFERENCES `character` (`character_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `character_quest_ibfk_2` FOREIGN KEY (`quest_id`) REFERENCES `quest` (`quest_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `inventory_item`
--
ALTER TABLE `inventory_item`
  ADD CONSTRAINT `inventory_item_ibfk_1` FOREIGN KEY (`inventory_id`) REFERENCES `inventory` (`inventory_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `inventory_item_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `item` (`item_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `quest`
--
ALTER TABLE `quest`
  ADD CONSTRAINT `quest_ibfk_2` FOREIGN KEY (`difficulty_id`) REFERENCES `difficulty` (`difficulty_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `quest_ibfk_3` FOREIGN KEY (`region_id`) REFERENCES `region` (`region_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
