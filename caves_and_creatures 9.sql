...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2024 at 11:11 AM
...
(2, 2, 'gangstaWizard', 'dont mess with me', 1, 2, 2, 2, 2),
(3, 3, 'gigachad23', 'im afk', 1, 3, 3, 3, 3),
(4, 4, 'iloveMK', 'i just like to play MK', 1, 4, 4, 4, 4),
(5, 5, 'MoogyBear', '........im a bear', 1, 5, 5, 5, 5),
(6, 6, 'gothikk', 'i dont like to talk much', 1, 6, 6, 6, 6),
(7, 7, 'holyPoggers', 'i go to church every Sunday.', 1, 7, 7, 7, 7),
(8, 8, 'Barbie', 'No, i don\'t play with dolls', 1, 8, 8, 8, 8),
(9, 9, 'divineSwagg77', 'i love jesus..obviously\r\n\r\nbr br', 1, 9, 9, 9, 9),
(10, 10, 'Swifty', 'I like shape-shifting, my Pronouns Are \"He,\" Not \"Him,\" Cause I\'ll Never Be \"Him\"', 1, 10, 10, 10, 10);
...
CREATE TABLE `character_quest` (
  `character_quest_id` int(12) NOT NULL,
...
(1, 'very easy', 'A breeze for beginners, offering a relaxed experience with minimal challenge.'),
(2, 'easy', 'Accessible for most players, providing a comfortable level of challenge without overwhelming difficulty.'),
(3, 'medium', 'Provides a moderate amount of challenge. Because it\'s not too easy nor too challenging, players of ordinary skill can still enjoy the game.'),
(4, 'hard', 'For skilled players seeking a demanding experience, requiring focus and determination to overcome obstacles.'),
(5, 'extreme', 'Reserved for the elite, presenting a formidable test of skill and precision, suitable only for the most dedicated players.');
...
CREATE TABLE `inventory_item` (
  `inventory_item_id` int(12) NOT NULL,
  `inventory_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(6, 'Scythe of Balrog', '2-H ATK DMG: 210 ~ 283\r\nATK Speed: 15\r\n\r\nRequirements:\r\nStrength: 570\r\nAgility: 120\r\nClass: Blade Master, Magic Knight, Barbarian, Warrior.\r\n\r\nExpires in: 29 days, 8 hours, 59 seconds.', 9, 8),
(7, 'Asura', '2-H ATK DMG: 300 ~ 423\r\nATK Speed: 20\r\n+3 Socket slots.\r\n\r\nRequirements:\r\nStrength: 700\r\nAgility: 320\r\nEnergy:128\r\nClass: Magic Knight', 10, 10),
(8, 'Reigning Cloak', 'DMG: +39%\r\nAbsorb DMG: +39%\r\n+Increased Movement Speed\r\n\r\nRequirements:\r\nCharacter Level 400\r\nClass: Hunter, Druid', 13, 1),
(9, 'Wings of Satan', 'DMG: +12%\r\nAbsorb DMG: +12%\r\n+Increased Movement Speed\r\n\r\nRequirements:\r\nCharacter Level 150\r\nClass: Blade Master, Warrior, Slaughterer, Barbarian', 13, 1),
(10, 'Wings of Heaven', 'DMG: +32%\r\nAbsorb DMG: +25%\r\n+Increased Movement Speed\r\n\r\nRequirements:\r\nCharacter Level 215\r\nClass: Wizard, Magic Knight, Paladin, Priest.', 13, 1),
(11, 'Wings of Carnage', 'DMG: +55%\r\nAbsorb DMG: +43%\r\n+Increased Movement Speed\r\n\r\nRequirements:\r\nCharacter Level 800\r\nClass: Slaughterer', 13, 1),
(12, 'Mana Potion', 'It is used to recover mana over time.\r\n\r\nStacks up to x3.', 14, 1),
(13, 'Apple', 'It is used to instantly recover a small amount of HP.\r\n\r\nStacks up to x3', 14, 1),
(14, 'Antidote', 'It is used to instantly remove Poison DMG debuff.\r\n\r\nStacks up to x3', 14, 1),
(15, 'Health Potion', 'It is used to recover health over time.\r\n\r\nStacks up to x3.', 14, 1),
(16, '$', 'Zen Dollar Coins ($), are the primary medium of exchange for goods and services.', 15, 1);
...
(14, 'consumable', 'Item that is only use-able a limited number of times (typically once) before being used, discarded or destroyed.'),
(15, 'currency', 'System of value that makes the exchange of goods and services possible.');
...
(2, 'Rusty', 'Kuntz', 'kam1995', 'SafariGun95', 'alternator1995@gmail.com', '05.11.1995'),
(3, 'Fia', 'Reisek', 'fairyelf88', '013r4j8!', 'fiagaming@yahoo.com', '09.02.2001'),
(4, 'Mo', 'Lester', 'supermanSouljaboy', 'canOpener!', 'fromthenorth91@outlook.com', '12.24.1992'),
(5, 'Paige', 'Turner', 'Evovar', 'q1w2e3r4', 'crazydragon@abv.bg', '11.05.2002'),
(6, 'Ben', 'Dover', 'Johnny666', 'comingforYou666', 'wickedJohnny@hotmail.com', '04.12.1993'),
...
(9, 'Steven', 'Spielberg', 'RK55', 'rTk123456', 'baseballking@gmail.com', '05.12.1995'),
(10, 'Laz', 'Anya', 'molly99', 'tryingTofindher99', 'lesterswagg@hotmail.com', '02.06.1999');
...
--
ALTER TABLE `character_quest`
  MODIFY `character_quest_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `inventory_item`
  MODIFY `inventory_item_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `item`
--
ALTER TABLE `item`
  MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9787;
...
--
ALTER TABLE `character`
  ADD CONSTRAINT `character_ibfk_1` FOREIGN KEY (`player_id`) REFERENCES `player` (`player_id`),
  ADD CONSTRAINT `character_ibfk_2` FOREIGN KEY (`alignment_id`) REFERENCES `alignment` (`alignment_id`),
  ADD CONSTRAINT `character_ibfk_3` FOREIGN KEY (`species_id`) REFERENCES `species` (`species_id`),
  ADD CONSTRAINT `character_ibfk_4` FOREIGN KEY (`class_id`) REFERENCES `class` (`class_id`),
  ADD CONSTRAINT `character_ibfk_5` FOREIGN KEY (`character_type_id`) REFERENCES `character_type` (`character_type_id`),
  ADD CONSTRAINT `character_ibfk_6` FOREIGN KEY (`inventory_id`) REFERENCES `inventory` (`inventory_id`);

--
-- Constraints for table `character_quest`
--
ALTER TABLE `character_quest`
  ADD CONSTRAINT `character_quest_ibfk_1` FOREIGN KEY (`character_id`) REFERENCES `character` (`character_id`),
  ADD CONSTRAINT `character_quest_ibfk_2` FOREIGN KEY (`quest_id`) REFERENCES `quest` (`quest_id`);
...
--
ALTER TABLE `item`
  ADD CONSTRAINT `item_ibfk_1` FOREIGN KEY (`item_rarity_id`) REFERENCES `item_rarity` (`item_rarity_id`),
